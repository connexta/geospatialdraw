...
var usng_point_editor_1 = __importDefault(require("./usng-point-editor"));
...
var USNGBBoxEditor = function (_a) {
    ...
    return (React.createElement(Root, { flexDirection: "row" },
        React.createElement(PointGroup, null,
            ...
            React.createElement(usng_point_editor_1.default, { lat: upperLeft.lat, lon: upperLeft.lon, setCoordinate: function (lat, lon) {
                    setBBox(bbox_1.coordinatePairToBBox([{ lat: lat, lon: lon }, lowerRight]));
                } })),
        React.createElement(PointGroup, null,
            React.createElement(Label, null, "Lower Right"),
            React.createElement(usng_point_editor_1.default, { lat: lowerRight.lat, lon: lowerRight.lon, setCoordinate: function (lat, lon) {
